...
- **URL Intelligence**: Dual detection modes - Google Safe Browsing API for real-time threat database lookups or ML model for pattern-based classification
...
with col2:
    ...
    <div class="feature-box">
        ...
        <p>Choose between Safe Browsing API or ML model detection. Includes DNS resolution, redirect analysis, and TLS validation.</p>
    </div>
    """, unsafe_allow_html=True)
